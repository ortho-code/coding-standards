...
return static function (RectorConfig $rectorConfig): void {
    $rectorConfig->sets([
        ...
        SetList::INSTANCEOF,
        SetList::PHP_82, // the tier's runtime floor; raise it with the php requirement, never ahead of it
    ...
    $rectorConfig->skip([
        ...
        NewlineAfterStatementRector::class, // blank lines belong to the formatter
        NewlineBeforeNewAssignSetRector::class, // blank lines belong to the formatter
        NewlineBetweenClassLikeStmtsRector::class, // blank lines belong to the formatter
